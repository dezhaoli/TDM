package com.naruto.debugger 
{
	...
	internal class DConnection
	{
		...
		// Connector class
		private static var connector:IConnection;
		...
		{
			/*FDT_IGNORE*/
			/*CONFIG::Default*/ { connector = new DConnectionDefault(); }
			/*FDT_IGNORE*/
			
			/*FDT_IGNORE*/
			//CONFIG::Mobile { connector = new TranslationDebuggerConnectionMobile(); }
			/*FDT_IGNORE*/
		}
