package com.naruto.debugger.socket
{
	...
	public class DConnectionDefault 
	{
		...
		public function DConnectionDefault()
		{
			// Create the socket
			_socket = new Socket();
...
//				catch(e:Error)
//				{
//					// TranslationDebugger.logger(["error"]);
//					// TranslationDebugger.logger([e.message]);
//					closeHandler();
//				}
//			}
//		}
...
//			
//			// Get the data
//			var bytes:ByteArray = DData(_queue.shift()).bytes;
//			
//			// Write it to the socket
//			_socket.writeUnsignedInt(bytes.length);
//			_socket.writeUTFBytes("LDZ");
...
//		
		...
		private function dataHandler(event:ProgressEvent):void
		{
			...
			trace("read :"+_bytes.readUTFBytes(_bytes.length));
