package com.naruto.debugger.socket
{
	...
	public final class SocketClientAndroid implements IClient
	{
		...
		public function SocketClient(socket:Socket)
		{
			...
			_package.endian = Endian.LITTLE_ENDIAN;
			_length = 0;
		...
		public function send(id:String, data:Object):void
		{
			...
			if (_socket != null) {
				...
				// The package
				var bytes:ByteArray = new DData(cmd, js,Endian.LITTLE_ENDIAN).bytes;
