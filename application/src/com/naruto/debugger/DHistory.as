package com.naruto.debugger
{
	...
	public class DHistory
	{
		...
		// Recents
		public static var items:Vector.<DHistoryItem> = new Vector.<DHistoryItem>();	
		...
		public static function load():void
		{
			...
			if (file.exists) {
				...
				for (var i:int = 0; i < itemXML.length(); i++) {
					...
					// Add item
					var item:DHistoryItem = new DHistoryItem();
		 ...
		 * Add an item
		 */
		public static function add(client:IClient):void
		{
			...
			if ( client.fileLocation.indexOf("http://") == 0 || client.fileLocation.indexOf("https://") == 0) {
				...
				// Add
				var itemWeb:DHistoryItem = new DHistoryItem();
			...
			if (file.exists) {
				...
				// Add
				var itemFile:DHistoryItem = new DHistoryItem();
